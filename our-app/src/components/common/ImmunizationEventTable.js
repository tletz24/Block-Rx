        ...
        <Table striped bordered hover>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{props.immunizationEvent.vExceptionDate}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{props.immunizationEvent.vAdminDate}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{props.immunizationEvent.vExpirationDate}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{props.immunizationEvent.vInfoStatementPubDate}</td>
                </tr>
                <tr>
                    <td>Vaccine Information Statement Date</td>
                    <td>{props.immunizationEvent.vInfoStatementDate}</td>
                </tr>
                <tr>
